...
def make_bpe_file(input_path, output_path, 
                  encoder_path="./gpt2-small/encoder.json", 
                  vocab_path="./gpt2-small/vocab.bpe"):
...
def make_gpt2_vocab(vocab_path="./encoder.json", output_path="./gpt2_vocab.txt"):
...
#                 256)
    ...
    make_bpe_file("yelp_train_reviews.txt", "yelp_train_reviews_bpe.txt")
    make_bpe_file("yelp_test_reviews.txt", "yelp_test_reviews_bpe.txt")
    make_bpe_file("yelp_unlabeled_reviews.txt", "yelp_unlabeled_reviews_bpe.txt")
#     make_gpt2_vocab()
