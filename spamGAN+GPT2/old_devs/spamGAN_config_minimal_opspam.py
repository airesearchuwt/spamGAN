...
checkpoint_dir= './ckpt' # Where to store ckpt files
...
clas_test_ckpts = [os.path.join(checkpoint_dir, "ckpt-all"),
                   os.path.join(checkpoint_dir, "ckpt-bestclas-max-acc"),
                   os.path.join(checkpoint_dir, "ckpt-bestclas-min-loss")] # Which checkpoint to use for classifier testing
