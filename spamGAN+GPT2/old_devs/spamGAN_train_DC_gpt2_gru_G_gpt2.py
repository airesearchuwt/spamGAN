...
class GPT2Embedder(tf.keras.Model):
    def __init__(self, gpt2_emb_config):
        ...
        self.embedder = tx.modules.GPT2Encoder(hparams=gpt2_emb_config)
...
#         config = importlib.import_module('spamGAN_config_minimal')
        config = importlib.import_module('spamGAN_config_smallunsup_cpu')
    else:
...
#                                              dtype=tf.float32)
        ...
        gpt2_emb_model = GPT2Embedder(config.gpt2_emb_hparams)
        gpt2_embedder = gpt2_emb_model.embedder
...
#                 max_decoding_length = max_length)
            ...
            gen_outputs, gen_lengths = g_decoder(
                ...
                spamGAN_sample_context=random_vector,
                mode=generator_dropout,
                max_decoding_length=max_length,
...
#             gen_lengths = tf.shape(gen_sample_ids)[1]
