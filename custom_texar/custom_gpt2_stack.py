...
class GPT2Stack():
    ...
    def __init__(self,
        ...
        self._use_transformer_encoder = False if hparams["use_transformer_encoder"] is False else True
        self._encode_mode = hparams["encode_mode"] if hparams["use_transformer_encoder"] is False and \
            "encode_mode" in hparams.keys() else False
    ...
    def _transform_config(self, pretrained_model_name: str, 
        ...
        configs.update({module_name: {
            ...
            "embedding_dropout": hparams["transformer"]["embedding_dropout"],
            "residual_dropout": hparams["transformer"]["residual_dropout"],
            "multihead_attention": {
                "use_bias": True,
                "num_units": hidden_dim,
                "num_heads": config_gpt["n_head"],
                "output_dim": hidden_dim,
                "dropout_rate": hparams["transformer"]["multihead_attention"]["dropout_rate"],
                "name": "self"
            },
            "initializer": {
