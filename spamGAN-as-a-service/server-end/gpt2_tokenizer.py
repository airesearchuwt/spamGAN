...
def make_bpe_file(input_path, output_path, encoder_path="/home/ubuntu/spamGAN-as-a-Service/opspam/spamGAN_output/gpt2-small/encoder.json", 
    vocab_path="/home/ubuntu/spamGAN-as-a-Service/opspam/spamGAN_output/gpt2-small/vocab.bpe"):
...
def make_gpt2_vocab(vocab_path="./spamGAN_output/gpt2-small/encoder.json", output_path="./spamGAN_output/gpt2_vocab.txt"):
...
#   make_bpe_file("./test_review.txt", "./test_review_bpe.txt")
