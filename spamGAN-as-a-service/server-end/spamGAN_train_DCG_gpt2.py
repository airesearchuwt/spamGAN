...
def main(config = None):
    ...
    with g.as_default():
        ...
        unsup_iterator = tx.data.TrainTestDataIterator(test=test_data)
        nounsup_iterator = tx.data.TrainTestDataIterator(test=clas_test_data)
    ...
    with sess:
        ...
        with sum_writer:
            ...
            if config["gen_clas_test"] is not None and config["gen_clas_test"]:
                ...
                dict_res["results"] = clas_test_outputs["r_clas_preds"]
...
def start():
    config_file = "/home/ubuntu/spamGAN-as-a-Service/opspam/spamGAN_config_smallunsup_opspam.json"
    config = json.loads(open(config_file).read())
    config["gen_clas_test"] = True
    config["clas_test_ckpts"] = "ckpt-all"
    config["checkpoint_dir"] = "/home/ubuntu/spamGAN-as-a-Service/opspam/spamGAN_output/ckpt"
    config["test_data"]['datasets'][0]['files'] = '/home/ubuntu/spamGAN-as-a-Service/opspam/files/test_review_bpe.txt'
    config["test_data"]['datasets'][1]['files'] = '/home/ubuntu/spamGAN-as-a-Service/opspam/files/test_label.txt'
    config["test_data"]['datasets'][0]['vocab_file'] = '/home/ubuntu/spamGAN-as-a-Service/opspam/spamGAN_output/gpt2_vocab.txt'
    dict_res = {}
    dict_res = main(config)
    return dict_res["results"]
